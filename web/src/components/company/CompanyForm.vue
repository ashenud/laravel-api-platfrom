<template>
  <form class="py-4" @submit.prevent="emitSubmit">
    <div class="mb-2">
      <label for="customer_name" class="text-gray-700 block text-sm font-bold capitalize">
        name
      </label>
      <input id="customer_name" v-model="item.name" :class="[
    ...
    <div class="mb-2">
      <label for="customer_owner" class="text-gray-700 block text-sm font-bold capitalize">
        owner
      </label>
      <input id="customer_owner" v-model="item.owner" :class="[
        'mt-1 w-full px-3 py-2 border rounded',
